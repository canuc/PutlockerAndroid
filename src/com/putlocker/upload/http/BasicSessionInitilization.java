...
public class BasicSessionInitilization extends CookiePersistantHttpRequest {
	private final HttpContext _context;
	
	public BasicSessionInitilization( RequestCallback callback ) {
		super(Constants.BASE_URL + Constants.SIGNUP_PAGE, callback);
