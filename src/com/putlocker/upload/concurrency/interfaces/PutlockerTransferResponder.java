...
public interface PutlockerTransferResponder {
	void setPutlockerJobStatus(PutlockerUpDownloadJob job,DownloadStatus status);
	void setDownloadJobProgress(PutlockerUpDownloadJob job,Long bytes,Long bytesTotal);
}